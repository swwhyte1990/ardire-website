...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    intro:
      "The Glasgow 2026 Commonwealth Games is set to be one of the most significant sporting events ever hosted in Scotland. Árd Íre is proud to be part of it, delivering bespoke visitor programmes, VIP hospitality packages, and corporate experiences that allow businesses and private guests to make the very most of this landmark occasion.",
    highlights: [
